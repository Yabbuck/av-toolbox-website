...
Official website repository for the AV Toolbox Android app. A static HTML/CSS site intended for GitHub Pages, with no dependencies or build step.
...
To publish after review, push `main`, then select **Settings → Pages → Build and deployment → Deploy from a branch → main → / (root)** in GitHub. The default URL is `https://yabbuck.github.io/av-toolbox-website/`.

The final domain will be **avtoolbox.app**. No custom domain or DNS is configured by this scaffold.
